...
public static class SignalingHttpClient
{
    ...
    /// <param name="emitter">An ISignalEmitter (for example, an EphemeralOperation inside your coordinator).</param>
    /// <param name="ct">Cancellation token.</param>
    /// <returns>Response body as bytes.</returns>
        ...
        CancellationToken ct = default)
    {
        ...
        // If no length header, mark completion explicitly.

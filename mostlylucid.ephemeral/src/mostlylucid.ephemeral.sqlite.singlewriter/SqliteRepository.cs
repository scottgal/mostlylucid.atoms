    ...
    where TEntity : class
{
    ...
    /// </summary>
    protected virtual string GetEntityCacheKey(TKey id) => $"{TableName}:{id}";
    ...
    /// </summary>
    protected abstract Task<IReadOnlyList<TEntity>> ReadAllEntitiesAsync(SqliteConnection connection, CancellationToken ct);
